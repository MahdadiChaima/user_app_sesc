    ...
    return SafeArea(
      child: Scaffold(
        ...
        SizedBox(height: size.width/5,),
            Center(child: Directionality( textDirection: TextDirection.rtl,
                child: Text("نقاطك هي :",style: TextStyle(fontSize: size.width/10,color:colorUser.darkGray,fontFamily: 'Tajawal-Regular'),))),
